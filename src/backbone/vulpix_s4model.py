...
except ImportError:  # pragma: no cover - fallback for environments without pytorch_lightning
...
try:
    ...
    def contract_expression(*args, **kwargs):
        raise RuntimeError("opt_einsum is required for contract_expression in vulpix_s4model.")
